...
eq_stmt
        :SPACE EQ_OP SPACE      {printf("wow\n");}
        |SPACE EQ_OP            {printf("wow\n");}
        |EQ_OP SPACE            {printf("wow\n");}
        |EQ_OP                  {printf("wow\n");}
...
control_stmt
        :IF SPACE rel_expr THEN NUM_LITERAL
        {
                CurrentState=17;
        }
...
iterative_stmt
        :FOR SPACE assign_stmt SPACE TO SPACE num_expr SPACE STEP SPACE num_expr ENDL lines SPACE 
        {
                CurrentState=18;
        }
        |FOR SPACE assign_stmt SPACE TO SPACE num_expr lines SPACE NEXT SPACE var
        {
                CurrentState=19;
        }
